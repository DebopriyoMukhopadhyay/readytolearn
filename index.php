	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">ReadyToLearn</h1>
			</div>
						...
						<div id="team-memebers" class="owl-carousel owl-theme">
							<div class="team-member text-center">
								...
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Anish Ghosh</h4>
									<h4 class="team-member-designation">Front-End Developer</h4>
									<ul class="social-list">
										<li><a href="https://www.facebook.com/profile.php?id=100005156958586" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
							...
							<div class="team-member text-center">
								...
								<img src="img\Debopriyo.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Debopriyo Mukhopadhyay</h4>
									<h4 class="team-member-designation">Back End Developer</h4>
									<ul class="social-list">
										<li><a href="https://www.facebook.com/debopriyo.mukherjee.587" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
										<li><a href="https://twitter.com/b_u_k_k_a22" class="social-icon icon-gray"><i class="fa fa-twitter"></i></a></li>
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-google-plus"></i></a></li>
									</ul>
								</div>
							</div>
							...
							<div class="panel-group" id="accordian">
								...
								<?php 
								  ...
								  $con=mysqli_connect('localhost','root');
									...
									mysqli_select_db($con,'readytolearn');
							...
							<?php } ?>
								...
								<div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
										<div class="panel-body">
											<p>
												ReadyToLearn is an online E-learning website <br>
												here you can learn programming languages and improve your coding skills.	
											</p>
										</div>
									</div>
								</div>
